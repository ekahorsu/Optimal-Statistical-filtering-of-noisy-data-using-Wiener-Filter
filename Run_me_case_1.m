...
dn=sin(n*w0+theta);
dn = dn'; %% converting a row vector to column vector %%


%%% providing vn %%%
vn=0.04*randn(1,N);   %% Here the factor 0.04 is chosen such that the noise amplitude is essentially a fraction of the aplitude of dn
v1(1)=vn(1);
v2(1)=vn(1);
for i=2:N
